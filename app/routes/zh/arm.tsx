...
const ARM_PATH = '/zh/arm';
const ARM_TITLE = 'FRC 与 FTC 机械臂计算器和仿真器 | ReCalc';
const ARM_NAME = '机械臂计算器';
const ARM_DESCRIPTION =
  '仿真 FRC 和 FTC 机器人机械臂机构，使用 WPILib 状态空间仿真建模 DC 电机性能、传动比和机械臂动力学。';
...
export default function ChineseArm() {
              ...
              <div className="flex flex-col gap-3 p-4">
                ...
                <IOLine>
                  <NumberInput
                    ...
                    label="效率"
                    tooltip="机械臂传动和齿轮箱的效率。通常每级约为 92-97%。"
                    testId="efficiency"
                    labelAbove
                  />
                  <MeasurementInput
