...
const RATIO_PATH = '/zh/ratio';
const RATIO_TITLE = 'FRC 与 FTC 传动比计算器 | ReCalc';
const RATIO_NAME = '传动比计算器';
const RATIO_DESCRIPTION =
  '计算 FRC 和 FTC 机器人机构中的齿轮、同步带和链条传动比，并支持多级减速链计算。';
...
export default function ChineseRatio() {
    ...
    <div>
      ...
      <div className="flex flex-col gap-4 px-1 *:flex-1 md:flex-row md:gap-x-4">
        ...
        <div className="rounded-xl border bg-muted/20 p-4 shadow-sm">
          <div className="mb-3">
            <SectionLabel>级数</SectionLabel>
          </div>

          {/* Column headers */}
          <div className="mb-1 grid grid-cols-[auto_1fr_1fr_5rem_2.25rem] items-center gap-2 px-1">
            <span className="text-xs text-muted-foreground">级</span>
            <span className="text-xs text-muted-foreground">主动齿数</span>
            <span className="text-xs text-muted-foreground">从动齿数</span>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-xl border bg-muted/20 p-4 shadow-sm">
            <div className="mb-3 flex items-center justify-between gap-4">
              <SectionLabel>电机转速</SectionLabel>
